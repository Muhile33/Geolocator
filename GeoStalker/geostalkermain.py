...
def banner():
    ascii_banner = pyfiglet.figlet_format("GeoStalker")
    print(colored(ascii_banner, 'green'))

def geocode_location(location_name):
    geolocator = Nominatim(user_agent="geostalker_instagram")
...
def main():
    banner()
    parser = argparse.ArgumentParser(description="GeoStalker - Instagram/IP Geolocation OSINT Tool")
